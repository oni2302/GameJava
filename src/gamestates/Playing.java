...
public class Playing extends State implements Statemethods {
    ...
    public void loadData() {
        ...
        if (playerModel.getX() != 0 && playerModel.getY() != 0) {
            player.setSpawn(new Point(playerModel.getX(), playerModel.getY()));
        }
    ...
    private void save() throws SQLException {
        ...
        playerModel.setScore((int) score);
        playerModel.setLevel(levelManager.getLevelIndex());
        playerModel.saveScore();
    }
